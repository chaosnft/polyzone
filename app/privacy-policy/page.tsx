...
export const metadata = {
  title: "Privacy Policy | Polyzone",
  description: "Our privacy policy for aggregated news content by Polyzone.",
};
        ...
        <article className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              Polyzone ("we", "us", or "our") is a community-driven platform that aggregates and curates news from verified
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              ...
              <ul className="mt-4 list-disc pl-6 space-y-2">
                <li>
                  Google Translate (language switching): May collect usage data; see their{" "}
                ...
                <li>
                  Cookies: Used for session management and preferences (e.g., language). No tracking cookies unless you
                  accept via our banner.
                </li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              Data is used solely to improve user experience (e.g., language translation). We do not sell, share, or use
              data for advertising. Aggregated content is for informational purposes only.
            </p>
          </section>
          <section className="mb-8">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4">Geolocation</h2>
            <p className="text-gray-700">
              We may use geolocation services to restrict access from certain regions for legal compliance. This data is not
              stored or used for tracking.
            </p>
          </section>
          <section className="mb-8">
